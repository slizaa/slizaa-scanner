...
public class SystemDefinitionFactory_Reload_Test {
  ...
  public void testSystemDefinition() throws IOException {
    ...
    ISystemDefinition systemDefinition = TestHelper.createDefaultSystemDefinitionWithWorkingCopy();
    try (FileReader fileReader = new FileReader(targetFile)) {
      new SystemDefinitionFactory().reloadSystemDefinition(systemDefinition, fileReader,
