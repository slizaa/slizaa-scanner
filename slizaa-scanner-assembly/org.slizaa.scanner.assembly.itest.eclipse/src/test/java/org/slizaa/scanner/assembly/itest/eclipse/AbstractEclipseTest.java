...
public abstract class AbstractEclipseTest {
  ...
  public Option[] config() throws IOException {
    ...
    File jtypeFile = MavenResolvers.createMavenResolver(null, null).resolve("org.slizaa.scanner.jtype",
        "org.slizaa.scanner.jtype", null, null,
        MavenUtils.getArtifactVersion("org.slizaa.scanner.jtype", "org.slizaa.scanner.jtype"));
    ...
    return options(
        ...
        mavenBundle("org.eclipse.equinox", "common").versionAsInProject(),
