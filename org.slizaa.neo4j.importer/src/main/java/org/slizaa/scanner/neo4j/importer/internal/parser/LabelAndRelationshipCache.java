...
public class LabelAndRelationshipCache {
  ...
  public static Label convert(org.slizaa.scanner.spi.parser.model.Label slizaaLabel) {
   ...
   * @return
   */
  public static Label[] convert(org.slizaa.scanner.spi.parser.model.Label[] slizaaLabels) {
  ...
  public static RelationshipType convert(org.slizaa.scanner.spi.parser.model.RelationshipType relationshipType) {
   ...
   * @return
   */
  public Label getLabel(org.slizaa.scanner.spi.parser.model.Label slizaaLabel) {
    return _labelCache.getUnchecked(checkNotNull(slizaaLabel.name()));
  }

  public RelationshipType getRelationship(org.slizaa.scanner.spi.parser.model.RelationshipType relationshipType) {
