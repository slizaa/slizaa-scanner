...
public enum JTypeModelRelationshipType implements RelationshipType {
  ...
  EXTENDS, IMPLEMENTS, BOUND_TO, HAS_PARAMETER, RETURNS, THROWS, IS_OF_TYPE, READ, WRITE, ANNOTATED_BY, USES, INVOKES, DEFINES_INNER_CLASS, IS_INNER_CLASS_DEFINED_BY,
