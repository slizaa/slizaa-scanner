 ...
 ******************************************************************************/
package org.slizaa.scanner.spi.content;

import java.util.List;

/**
 * <p>
 * Represents the definition of the system that should be analyzed. A {@link IContentDefinitions} can be created using
 * the {@link ISystemDefinitionFactory}.
 * </p>
 * <p>
 * 
 * </p>
