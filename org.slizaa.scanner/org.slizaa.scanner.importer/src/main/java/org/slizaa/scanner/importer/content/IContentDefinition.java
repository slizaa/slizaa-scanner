...
public interface IContentDefinition {
  ...
  /**
   * <p>
   * Returns all binary root paths of this {@link IContentDefinition}.
   * </p>
   * 
   * @return all binary root paths of this {@link IContentDefinition}.
   */
  List<VariablePath> getBinaryRootPaths();

  /**
   * <p>
   * Returns all source root paths of this {@link IContentDefinition}.
   * </p>
   * 
   * @return all source root paths of this {@link IContentDefinition}.
   */
  List<VariablePath> getSourceRootPaths();
  ...
  /**
   * <p>
   * Returns the resource with the given path and the given type. Returns <code>null</code> if no such resource exists.
   * </p>
   * 
   * @param path
   ...
   * @return the resource
   */
  IResource getResource(String path, ResourceType type);
}
